  ...
  constructor(obj?: any) {
    if (obj != null) {
      if (typeof obj === 'object') {
        ...
        if (obj.firstName != null) this.firstName = obj.firstName
        if (obj.lastName != null) this.lastName = obj.lastName
        if (obj.name != null) this.name = obj.name
        if (obj.address != null) this.address = obj.address
        if (obj.postalCode != null) this.postalCode = obj.postalCode
        if (obj.postalOffice != null) this.postalOffice = obj.postalOffice
        if (obj.country != null)
          this.country = obj.country != null ? obj.country : 'Slovenija'
        if (obj.isTaxPayer != null) this.isTaxPayer = obj.isTaxPayer
        if (obj.taxId != null) this.taxId = obj.taxId
        if (obj.regNo != null) this.regNo = obj.regNo
        if (obj.bankName != null) this.bankName = obj.bankName
        if (obj.bankBIC != null) this.bankBIC = obj.bankBIC
        if (obj.bankTRR != null) this.bankTRR = obj.bankTRR
        if (obj.email != null) this.email = obj.email
        if (obj.phone != null) this.phone = obj.phone
        if (obj.fax != null) this.fax = obj.fax
        if (obj.website != null) this.website = obj.website
