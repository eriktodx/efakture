  ...
  constructor(obj?: any) {
    if (obj != null) {
      if (typeof obj === "object") {
        ...
        if (obj.items != null) {
          this.items = obj.items.map((x: any) => new ItemModel(x));
        }
        ...
        if (obj.payments != null) {
          this.payments = obj.payments.map((x: any) => new PaymentModel(x));
        }
        if (obj.revisions != null) {
          this.revisions = obj.revisions.map((x: any) => new InvoiceModel(x));
        }
        if (obj.deleted != null) {
